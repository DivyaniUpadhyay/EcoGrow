...
# (1) Azure Static Web app:
     Static Web app is a services provided by Microsoft Azure . It is designed to setup, configure, build, deploy, and host modern web application.With the help of this user can easily navigate the site,
